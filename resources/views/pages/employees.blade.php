    ...
    <div class="table-responsive m-3">
        ...
        <div class="container-fluid py-2 d-flex align-items-center justify-content-between">
            <form action="" class="d-flex align-items-center gap-2">
                <input type="search" name="search" value="{{$search}}" placeholder="Search name:" class="px-2 py-1 rounded-2 border border-secondary"/>
            ...
            <div class="btn-actions-div">
                <a  class="btn btn-primary mb-1 px-4"
                    href="{{url('/create')}}"
                    role="button"
                >
                    ADD
                ...
                <a   class="btn btn-danger mb-1 px-4"
                        href="{{url('/trash')}}"
                        role="button"
                >
                        View Trash
